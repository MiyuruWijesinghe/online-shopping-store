...
export default function ConferenceDetailsListAdmin(props) {
    ...
    function viewConferenceDetails(conferenceDetailId) {
        props.history.push("conference-detail-admin/"+conferenceDetailId)
    }

    function viewPageLink(cell, row, rowIndex, formatExtraData) {
        return (
            <button className="btn btn-info btn-sm" onClick={() => viewConferenceDetails(row.id)}>View</button>
        );
    }
